              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form id="accessForm" action="#" method="POST">
                          ...
                          <div class="form-group">
                            <label for="pilih_akses">Pilih Akses</label>
                            <select class="form-control" id="pilih_akses" name="pilih_akses" disabled>
                                <option value="Analisis Jabatan">Analisis Jabatan</option>
                                <option value="Analisis Beban Kerja">Analisis Beban Kerja</option>
