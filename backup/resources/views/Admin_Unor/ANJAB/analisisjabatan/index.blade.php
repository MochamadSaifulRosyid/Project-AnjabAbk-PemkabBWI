  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Analisis Jabatan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Analisis Jabatan</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <a href="{{ route('analisisjabatan.create') }}" class="btn btn-primary mb-3">Tambah Data</a>
